...
def dataImport():
    ...
    covidCanadaTotalCases_df = pandas.read_csv("~/Desktop/CanadaCovid.csv")
    covidCanadaTotalDeaths_df = pandas.read_csv("~/Desktop/CanadaCovidDeath.csv")
    covidCanadaTotalRecovered_df = pandas.read_csv("~/Desktop/CanadaCovidRecovered.csv")
...
def main():
    covidCanadaTotal_df, covidAB_df, covidBC_df, covidMN_df, covidNB_df, covidNL_df, covidNS_df, covidON_df, covidPE_df, covidQC_df, covidSA_df = dataImport()
